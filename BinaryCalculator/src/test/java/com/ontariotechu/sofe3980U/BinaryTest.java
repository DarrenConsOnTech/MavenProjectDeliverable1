...
public class BinaryTest 
{
	...
	/**
     * Test the or function with two binary, the length of the second binary string is shorter than the first
     */
    @Test
    public void or2()
    {
	...
	/**
     * Test the or function with two binary numbers, the length of the second binary string is longer than the first
     */
    @Test
    public void or3()
    {
...
@Test
    public void bitMultiply1()
    {
        Binary binary1 = new Binary("1010");
        Binary binary2 = new Binary("11");
        Binary binary3 = Binary.bitMultiply(binary1, binary2);
        assertTrue(binary3.getValue().equals("11110"));
    }
