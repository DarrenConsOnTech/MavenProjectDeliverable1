...
public class Binary
{
	...
	*/
	...
	public static Binary or(Binary num1,Binary num2)
	{
		...
		int int1 = Integer.parseInt(num1.number, 2);
		// Takes string containing bits for num2; converts to decimal.
		int int2 = Integer.parseInt(num2.number, 2);

		// Bitwise OR operation for two integers is performed and stored within intResult.
		...
		Binary result = new Binary(Integer.toBinaryString(intResult));
		return result;
	...
	public static Binary multiply(Binary num1,Binary num2)
	{
		...
		// Integer multiplication is performed and stored within intResult.
		int intResult = int1 * int2;
	...
	public static Binary bitMultiply(Binary num1, Binary num2) {
